...
class RobotGraphHelperTest {
    ...
    @Test
    void testShouldLimitResultsGraphDataSet() {
    ...
    @Test
    void testShouldReturnAllResultsGraphDataIfNotLimited() {
    ...
    @Test
    void testShouldReturnAllResultsGraphDataIfLimitIsBiggerThanDataAmount() {
        RobotGraph notlimitedResultsGraph = RobotGraphHelper.createTestResultsGraphForTestObject(
    ...
    @Test
    void testShouldShowCustomLabel() {
    ...
    @Test
    void testShouldLimitDurationGraphDataSet() {
    ...
    @Test
    void testShouldReturnAllDurationGraphDataIfNotLimited() {
    ...
    @Test
    void testShouldReturnAllDurationDataIfLimitIsBiggerThanDataAmount() {
        RobotGraph notlimitedResultsGraph = RobotGraphHelper.createDurationGraphForTestObject(
